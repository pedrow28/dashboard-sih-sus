...
# ==============================================================================
# ⬇️ COLE ESTE BLOCO NO SEU APP.PY (antes do footer)
# ==============================================================================

    # CTA de Conversão THAUMA
    st.markdown("""
    <style>
        .thauma-cta-container {
            position: fixed;
            bottom: 0;
            left: 0;
            right: 0;
            z-index: 999999;
            pointer-events: none;
            animation: slideUpThauma 0.6s cubic-bezier(0.34, 1.56, 0.64, 1);
        }
        
        @keyframes slideUpThauma {
            from { transform: translateY(100%); opacity: 0; }
            to { transform: translateY(0); opacity: 1; }
        }
        
        .thauma-cta-banner {
            background: linear-gradient(135deg, #001070 0%, #001a8f 100%);
            box-shadow: 0 -8px 32px rgba(0, 16, 112, 0.25);
            pointer-events: all;
            position: relative;
        }
        
        .thauma-cta-banner::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
            height: 2px;
            background: linear-gradient(90deg, transparent 0%, #40D7FF 50%, transparent 100%);
            opacity: 0.6;
        }
        ...
        .thauma-icon {
            ...
            border: 2px solid rgba(64, 215, 255, 0.3);
            border-radius: 10px;
            display: flex;
            align-items: center;
        ...
        .thauma-brand-text { display: flex; flex-direction: column; }
        .thauma-brand-name {
            color: #FFFFFF;
            font-size: 16px;
            font-weight: 700;
        ...
        .thauma-content { display: flex; flex-direction: column; gap: 4px; }
        .thauma-headline {
            color: #FFFFFF;
            font-size: 18px;
            font-weight: 700;
        ...
        .thauma-highlight { color: #40D7FF; font-weight: 600; }
        ...
        .thauma-btn-primary {
            background: #40D7FF;
            color: #001070;
            box-shadow: 0 4px 12px rgba(64, 215, 255, 0.35);
        }
        .thauma-btn-primary:hover {
            background: #5ce0ff;
            transform: translateY(-2px);
            box-shadow: 0 6px 16px rgba(64, 215, 255, 0.5);
        }
        
        .thauma-btn-secondary {
            background: rgba(255, 255, 255, 0.12);
            color: #FFFFFF;
            border: 1.5px solid rgba(255, 255, 255, 0.3);
        }
        .thauma-btn-secondary:hover {
        ...
        .thauma-cta-container.hidden { display: none; }
        ...
        @media (max-width: 1024px) {
            ...
            .thauma-brand { justify-content: center; }
            .thauma-proof { justify-content: center; }
            .thauma-actions {
                width: 100%;
                max-width: 400px;
                margin: 0 auto;
        ...
        @media (max-width: 640px) {
            .thauma-icon { width: 40px; height: 40px; font-size: 20px; }
            .thauma-brand-name { font-size: 14px; }
            .thauma-headline { font-size: 16px; }
            .thauma-subheadline { font-size: 13px; }
            .thauma-btn { padding: 10px 16px; font-size: 13px; }
        }
    </style>
    
    <div class="thauma-cta-container" id="thaumaCTA">
        <div class="thauma-cta-banner">
            <button class="thauma-close" onclick="document.getElementById('thaumaCTA').classList.add('hidden')" aria-label="Fechar">×</button>
            
            <div class="thauma-cta-content">
                <div class="thauma-brand">
                    <div class="thauma-icon">🎯</div>
                    <div class="thauma-brand-text">
                        <div class="thauma-brand-name">THAUMA</div>
                        <div class="thauma-brand-tagline">Inteligência em Saúde</div>
                    </div>
                </div>
                
                <div class="thauma-content">
                    <h3 class="thauma-headline">Gostou dessa análise?</h3>
                    <p class="thauma-subheadline">
                        Transforme os dados do seu hospital em <span class="thauma-highlight">estratégia de captação científica</span>
                    </p>
                </div>
                
                <div class="thauma-actions">
                    <a href="https://www.linkedin.com/in/pedrowilliamrd/" 
                       target="_blank" 
                       class="thauma-btn thauma-btn-primary">
                        <span>💼</span>
                        <span>Vamos conversar no LinkedIn</span>
                    </a>
                    <a href="mailto:pedrowilliamrd@gmail.com?subject=Interesse%20Dashboard%20THAUMA&body=Olá%20Pedro,%0A%0AVisualizei%20seu%20dashboard%20e%20gostaria%20de%20conversar%20sobre%20a%20metodologia%20THAUMA.%0A%0AHospital:%20%0ACargo:%20%0ATelefone:%20%0A%0AAguardo%20retorno!" 
                       class="thauma-btn thauma-btn-secondary">
                        <span>✉️</span>
                        <span>Enviar e-mail</span>
                    </a>
                    <div class="thauma-contact-hint">Resposta em até 24h</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        setTimeout(function() {
            var cta = document.getElementById('thaumaCTA');
